    ...
    <ScreenContainer>
      ...
      {isCreating ? (
        <SectionCard style={styles.createCard}>
          ...
          <GradientButton label="Save Quiz" onPress={saveQuiz} disabled={draftQuestions.length === 0 || !title.trim()} />
        </SectionCard>
      ) : null}
        ...
        <SectionCard key={quiz.id} style={styles.quizCard}>
          <View style={styles.quizInfo}>
            <View style={styles.tagRow}>
              ...
              <Text style={styles.questionCount}>{quiz.questions.length} Qs</Text>
            </View>
